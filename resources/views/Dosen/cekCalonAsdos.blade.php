...
<head>
    ...
    <title>Dosen - Daftar Calon Asdos</title>
...
<div class="flex flex-1">
    <aside class="w-64 bg-white shadow-xl border-r border-gray-200 flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="/Dosen" class="flex items-center px-4 py-3 roundded-xl hover:bg-blue-100 hover:text-blue-700 font-semibold transition-all shadow-md">
            ...
            <a href="/Dosen/cekCalonAsdos" class="flex items-center px-4 py-3 rounded-xl text-gray-700 bg-blue-600 text-white transition-all font-medium">
    ...
    <main class="flex-1 p-8 bg-gray-50">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Daftar Calon Asisten Dosen</h1>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="/Dosen/detail" class="px-3 py-1.5 bg-blue-400 text-gray-800 rounded-md hover:bg-blue-500 transition text-xs font-semibold shadow-sm">
                                        Detail
                                    </a>
                                    <a href="/Dosen/cekCalonAsdos" class="px-3 py-1.5 bg-yellow-400 text-gray-800 rounded-md hover:bg-blue-500 transition text-xs font-semibold shadow-sm">
                                        Hubungi
                                    </a>
                                </div>
                            </td>
