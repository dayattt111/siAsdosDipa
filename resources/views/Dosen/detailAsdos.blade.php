...
<div style="max-width: 800px; margin: 0 auto;">
    <h2 style="font-size: 24px; color: #333; margin-bottom: 20px; border-bottom: 2px solid #3182ce; padding-bottom: 10px;">📋 Detail Asdos</h2>
    ...
    <form action="/Dosen" method="POST">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 30px;">
            <a href="/Dosen" style="padding: 10px 20px; background: #6c757d; color: white; border-radius: 5px; text-decoration: none;">
                ← Kembali
            </a>
