...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-8 bg-gray-50">
        ...
        <div class="flex justify-between items-center mb-6">
            <a href="/Admin/TambahAsdos" class="px-5 py-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition font-medium">Tambah</a>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <a href="/Admin/editAsdos" class="px-3 py-1.5 bg-yellow-400 text-gray-800 rounded-md hover:bg-yellow-500 transition text-xs font-semibold shadow-sm">
                                        Edit
                                    </a>
