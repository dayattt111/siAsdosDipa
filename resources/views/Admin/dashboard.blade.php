...
<head>
    ...
    <title>Dashboard Admin - Manajemen Asdos</title>
    <style>
    ...
    <div class="layout">
        ...
        <div class="stats">
            <div class="stat-card">
                ...
                <div class="number">{{ $totalMahasiswa }}</div>
            </div>
            <div class="stat-card">
                <h3>Total Dosen</h3>
            ...
            <div class="stat-card">
                <h3>Total Asdos Aktif</h3>
                <div class="number">{{ $totalAsdos }}</div>
            </div>
            <div class="stat-card">
                <h3>Pendaftar Menunggu</h3>
                <div class="number">{{ $totalPendaftar }}</div>
            </div>
        </div>

        <h2 style="margin-bottom: 20px;">Menu Admin</h2>
        <div class="menu-grid">
            <a href="/admin/asdos" class="menu-card">
                <h3>📋 Kelola Asdos</h3>
                <p>Lihat dan kelola data asdos</p>
            </a>
            <a href="/admin/pendaftar" class="menu-card">
                <h3>👥 Pendaftar Asdos</h3>
                <p>Kelola pendaftar asdos baru</p>
            </a>
