...
<head>
    ...
    <title>Tambah Pendaftar - Admin</title>
    <style>
...
<body>
    ...
    <div class="layout">
        ...
        <div class="content">
            <div class="container">
                <div class="form-card">
                    <h2 style="margin-bottom: 20px;">Form Tambah Pendaftar Asdos</h2>

                    <form action="/admin/pendaftar" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select id="matakuliah_id" name="matakuliah_id" required onchange="updateMataKuliah()">
                                ...
                                @foreach($matakuliah as $mk)
                                    <option value="{{ $mk->id }}" data-kode="{{ $mk->kode_mk }}" data-semester="{{ $mk->semester }}" {{ old('matakuliah_id') == $mk->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ipk" name="ipk" value="{{ old('ipk') }}" placeholder="Contoh: 3.50" required>
                            @error('ipk')<div class="error">{{ $message }}</div>@enderror
                        </div>

                        <div class="form-group">
                            <label for="motivasi">Motivasi</label>
                            <textarea id="motivasi" name="motivasi" placeholder="Jelaskan motivasi mendaftar sebagai asdos...">{{ old('motivasi') }}</textarea>
