...
<head>
    ...
    <title>Admin - Tambah Laporan</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-8 bg-gray-50">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            <h1 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-3">Buat Entri Laporan Baru</h1>
            ...
            <form action="/Admin/laporan" method="POST" class="space-y-6">
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t mt-6 border-gray-100">
                    ...
                    <button type="submit" class="px-5 py-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition font-medium">Simpan Laporan</button>
                </div>
            </form>
        </div>
    </main>
