...
<head>
    ...
    <title>Admin - Hapus Laporan</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-8 bg-gray-50">
        <div class="max-w-xl mx-auto mt-16 bg-white p-8 rounded-xl shadow-2xl border border-red-200 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Konfirmasi Penghapusan Laporan</h1>
            
            <p class="text-lg text-gray-600 mb-6">Anda yakin ingin menghapus entri laporan ini? Tindakan ini tidak dapat dibatalkan.</p>
            
            <div class="p-4 bg-red-50 rounded-lg mb-8 border border-red-300 text-left">
                <p class="text-sm font-medium text-red-800">Jadwal: <span class="font-bold">Basis Data (A)</span></p>
                <p class="text-sm text-red-700">Tanggal Laporan: 15 November 2025</p>
