...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-10 bg-gray-50">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Data Asdos</h1>
        ...
        <div class="max-w-3xl bg-white shadow-lg rounded-xl p-8 border border-gray-200">
            ...
            <form action="/Admin/Asdos" method="POST">
                ...
                <!-- Nama Asdos -->
                <div class="mb-5">
                    <label class="block font-medium text-gray-700 mb-2">Nama Asdos</label>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="/Admin/Asdos" class="px-5 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition">
                        Batal
                    </a>
