...
<head>
    ...
    <title>Admin - Hapus Jadwal</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-8 bg-gray-50">
        <div class="max-w-xl mx-auto mt-16 bg-white p-8 rounded-xl shadow-2xl border border-red-200 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Konfirmasi Penghapusan Jadwal</h1>
            
            <p class="text-lg text-gray-600 mb-6">Anda yakin ingin menghapus jadwal ini? Tindakan ini tidak dapat dibatalkan.</p>
            
            <div class="p-4 bg-red-50 rounded-lg mb-8 border border-red-300 text-left">
                <p class="text-sm font-medium text-red-800">Mata Kuliah: <span class="font-bold">Algoritma dan Struktur Data</span></p>
                <p class="text-sm text-red-700">Waktu: Senin, 08:00 - 09:40</p>
                <p class="text-sm text-red-700">Ruangan: Lab Komputer A</p>
            </div>
            
            <form action="/Admin/kelolaJadwal" method="POST" class="flex justify-center space-x-4">
                @csrf
                <a href="/Admin/kelolaJadwal" class="px-6 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition font-medium">Batal</a>
