...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-xl border-r border-gray-200 flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="/Admin/Asdos" class="block px-4 py-3 rounded-xl bg-blue-100 text-blue-700 font-semibold">Data Calon Asdos</a>
    ...
    <main class="flex-1 p-10 bg-gray-50">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Data Calon Asdos</h1>
